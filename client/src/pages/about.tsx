        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-6 leading-relaxed" data-testid="text-about-description-1">
              1998 yılından bu yana altın ve mücevherat sektöründe hizmet veren Çelik Kuyumcu, 
              müşterilerine en kaliteli ürünleri sunma konusunda kararlılığını sürdürmektedir.
            </p>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed" data-testid="text-about-description-2">
              Deneyimli ustalarımız ile her ürünümüzü özenle işliyor, müşteri memnuniyetini 
              en üst seviyede tutmaya odaklanıyoruz. Güven, kalite ve hizmet anlayışımızla 
              sizlere en iyisini sunuyoruz.
            </p>
          ...
          <div className="relative">
            <img 
              src="https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600" 
